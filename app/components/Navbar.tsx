...
export default function Navbar() {
  ...
  return (
    <nav className="bg-blue-900 text-white h-14 flex items-center px-6 gap-8 fixed top-0 left-0 right-0 z-40 shadow-md">
      {/* 로고 */}
      ...
      <div className="relative shrink-0" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-2 hover:bg-blue-800 px-3 py-1.5 rounded-lg transition"
        >
